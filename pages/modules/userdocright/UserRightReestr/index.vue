...
export default {
  ...
  methods: {
    Link(id) {
      return this.$router.push("/modules/userdocright/UserRightReestr/UserRight?id=" + id);
    },
    clickExit() {
    ...
    async clickNew() {
      ...
      if (answer.Error)
        ...
        return this.$router.push(
          "/userdocright/UserRightReestr/UserRight?id=" + answer.DocMovement.id
        );
      }
    },
    async clickDelete() {
